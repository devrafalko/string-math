module.exports = [
  ...
  {expression:"7 % 2",result:1},
  {expression:"15 % 4",result:3},
  {expression:"-10 % 3",result:-1},
  {expression:"-7 % 2",result:-1},
  {expression:"-15 % 4",result:-3},
  {expression:"10 % -3",result:1},
  ...
  {expression:"-7 % -2",result:-1},
  {expression:"-15 % -4",result:-3},
  {expression:"(10 + 4) % 6",result:2},
  {expression:"15 % (3 + 2)",result:0},
  {expression:"(8 - 3) % (2 + 2)",result:1},
  {expression:"((7 % 3) + (4 % 2)) % 2",result:1},
  {expression:"10 % 3 + 5 % 2",result:2},
  {expression:"((8 % 3) + 4) % (2 % 2 + 1)",result:0},
  {expression:"((3 % 2) * 5) % 4",result:1},
  {expression:"(6 + 7 * 2) % (3 + 1 * 2)",result:0},
  {expression:"(9 % 4) * (6 % 2) - (8 % 3)",result:-2},
  {expression:"(((15 % 6) + 8) * 2) % 7",result:1}
];
